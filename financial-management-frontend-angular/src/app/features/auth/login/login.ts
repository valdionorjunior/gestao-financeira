...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center">
          ...
          <div class="space-y-4">
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-2 border border-gray-300 dark:border-[var(--color-border)] rounded-lg bg-white dark:bg-[var(--color-surface)] text-gray-900 dark:text-[var(--color-text)] focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              />
            ...
            <div>
              ...
              <p-password
                ...
                [toggleMask]="true"
                styleClass="w-full"
                inputStyleClass="w-full px-4 py-2 border border-gray-300 dark:border-[var(--color-border)] rounded-lg bg-white dark:bg-[var(--color-surface)] text-gray-900 dark:text-[var(--color-text)] focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            ...
            <button
              ...
              class="w-full py-2 px-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-medium hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              @if (loading()) {
